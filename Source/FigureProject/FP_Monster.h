...
public:	
	...
	enum MONSTERICON {SQUARE_WHITE_A, SQUARE_WHITE_B, SQUARE_WHITE_C, SQUARE_WHITE_D, SQUARE_WHITE_HIT, SQUARE_WHITE_DEAD, TRIANGLE_WHITE_A, TRIANGLE_WHITE_B, TRIANGLE_WHITE_C, TRIANGLE_WHITE_D, TRIANGLE_WHITE_HIT, TRIANGLE_WHITE_DEAD};
	enum BEHAVIOUR { IDLE, HIT , DEAD};
